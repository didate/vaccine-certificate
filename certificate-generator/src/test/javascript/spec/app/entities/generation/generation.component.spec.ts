...
import { GenerationComponent } from 'app/entities/generation/generation.component';
...
describe('Component Tests', () => {
  describe('Generation Management Component', () => {
    let comp: GenerationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GenerationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.generations && comp.generations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
