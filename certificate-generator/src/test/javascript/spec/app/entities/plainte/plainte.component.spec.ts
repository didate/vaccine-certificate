...
import { PlainteComponent } from 'app/entities/plainte/plainte.component';
import { PlainteService } from 'app/entities/plainte/plainte.service';
import { Plainte } from 'app/shared/model/plainte.model';

describe('Component Tests', () => {
  describe('Plainte Management Component', () => {
    let comp: PlainteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PlainteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.plaintes && comp.plaintes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
