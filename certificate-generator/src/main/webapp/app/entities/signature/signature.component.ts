...
export class SignatureComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.signatureService
      ...
      .subscribe(
        (res: HttpResponse<ISignature[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSignatures(): void {
    this.eventSubscriber = this.eventManager.subscribe('signatureListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISignature[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
